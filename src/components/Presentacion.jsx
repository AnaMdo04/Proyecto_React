          ...
          <div className="modal-content">
            ...
            <div className="scrollable-content">
              ...
              <p>
                ...
                El juego puede ser jugado por 2 a 10 jugadores. Se reparten 7 cartas a cada jugador. Las cartas
                restantes se colocan boca abajo para formar el mazo de robar. La primera carta del mazo se coloca boca
                arriba al lado del mazo para comenzar la pila de descarte.
              </p>
              <h2>Desarrollo</h2>
              <p>
              ...
              <h3> Roba 2 </h3>
              <p>
                Hace que el siguiente jugador robe 2 cartas y pierda su turno. Salto: Salta al siguiente jugador,
                haciendo que pierda su turno.
              </p>
